...
Power = st.sidebar.slider("Power per module [kW]:", min_value=0.5, max_value=3.2, value=3.2, step=0.1,
                          help="Power [kW]")
...
# Sliders for the UVT
UVT254 = st.sidebar.slider("UVT at 254nm [%-1cm]:", min_value=40, max_value=96, value=92, step=1,
                           help="UV-Transmittance at 254nm [%-1cm]")
UVT215 = st.sidebar.slider("UVT at 215nm [%-1cm]:", min_value=40, max_value=96, value=92, step=1,
                           help="UV-Transmittance at 215nm [%-1cm]")
